...
// Define Space type based on Prisma schema
...
export default function SpacePublicClient({ space, session }: SpaceClientProps) {
      ...
      <PanelGroup direction="horizontal" className="h-full">
        <Panel defaultSize={showChat ? 50 : 100} minSize={30}>
          <div className="h-full flex flex-col overflow-hidden">
            {/* Fixed top section */}
            <div className="flex-none p-4 border-b border-gray-200 dark:border-zinc-800 bg-white dark:bg-transparent">
              ...
              <div className="p-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between w-full max-w-6xl mx-auto mb-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 mt-4 md:mt-0">
                    ...
                    <button className="flex items-center gap-2 px-6 py-2 rounded-2xl bg-purple-600 text-white font-semibold border border-purple-700 hover:bg-purple-700 transition" onClick={() => setShowExamModal(true)}>
                      <BookCheck className="h-4 w-4" />
                      Create Exam
                    </button>
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    {canManageSpace && (
                      <CreateMeetingButton 
                        ...
                        isOwner={currentSpace.userRole === "OWNER"}
                      />
                    )}
                  </div>
