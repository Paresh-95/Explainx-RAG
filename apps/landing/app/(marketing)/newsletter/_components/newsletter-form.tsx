          ...
          <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className={`h-12 bg-black/50 backdrop-blur-sm border-gray-800 text-white placeholder:text-gray-500 ${errors.email ? 'border-red-500' : 'focus:border-secondaccent focus:ring-secondaccent'
                  }`}
              />
              {errors.email && (
            ...
            <div className="space-y-3">
              ...
              >
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Label
                    htmlFor="developer"
                    className={`flex flex-col items-center justify-center gap-2 p-4 rounded-lg border-2 cursor-pointer transition-all ${formData.subscriberType === 'DEVELOPER'
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Label
                    htmlFor="business"
                    className={`flex flex-col items-center justify-center gap-2 p-4 rounded-lg border-2 cursor-pointer transition-all ${formData.subscriberType === 'BUSINESS'
                      ? 'border-secondaccent bg-secondaccent/10 text-secondaccent'
                      : 'border-gray-800 hover:border-secondaccent/50 text-gray-300'
                      }`}
                  >
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Label
                    htmlFor="enthusiast"
                    className={`flex flex-col items-center justify-center gap-2 p-4 rounded-lg border-2 cursor-pointer transition-all ${formData.subscriberType === 'ENTHUSIAST'
                      ? 'border-secondaccent bg-secondaccent/10 text-secondaccent'
                      : 'border-gray-800 hover:border-secondaccent/50 text-gray-300'
                      }`}
                  >
            ...
            <Button
              ...
              size="lg"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-full font-semibold shadow-lg transition-all"
            >
              {isLoading ? (
                <>
