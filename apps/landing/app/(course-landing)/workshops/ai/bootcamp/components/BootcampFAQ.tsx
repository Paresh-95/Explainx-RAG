      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="flex justify-center mb-6">
            <div className="p-3 rounded-full bg-purple-100 dark:bg-purple-600/20">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <Card key={index} className="bg-white border-gray-200 hover:bg-gray-50 dark:bg-gray-800/50 dark:border-gray-700 dark:hover:bg-gray-800/70 transition-all duration-300">
        ...
        <div className="mt-12 text-center">
          <Card className="bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-600/20 dark:to-blue-600/20 border-purple-200 dark:border-purple-500/50">
            <CardContent className="p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button 
                  ...
                  className="bg-purple-600 hover:bg-purple-700 text-white dark:bg-purple-500 dark:hover:bg-purple-600 px-6 py-3 rounded-lg font-semibold transition-colors"
                >
                  Schedule a Call
                </button>
                <button 
                  onClick={() => window.open('mailto:support@explainx.ai', '_blank')}
                  className="border border-gray-300 text-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800 px-6 py-3 rounded-lg font-semibold transition-colors"
                >
                  Email Support
                </button>
              </div>
