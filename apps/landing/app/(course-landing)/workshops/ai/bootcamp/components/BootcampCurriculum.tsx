      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          {weekData.map((week, index) => {
            ...
            return (
              <Card key={week.week} className="bg-white border-gray-200 hover:bg-gray-50 dark:bg-gray-800/50 dark:border-gray-700 dark:hover:bg-gray-800/70 transition-all duration-300">
                <CardHeader>
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <CardTitle className="text-2xl text-gray-900 dark:text-white mb-2">{week.title}</CardTitle>
                ...
                <CardContent>
                  <div className="grid md:grid-cols-3 gap-6">
                    ...
                    {/* Tools */}
                    <div>
                      <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Tools Covered</h4>
                      <div className="flex flex-wrap gap-2">
                        {week.tools.map((tool, idx) => (
                          <Badge key={idx} className="bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600">
                            {tool}
                          </Badge>
                        ))}
                      </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-600/20 dark:to-blue-600/20 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Badge className="bg-green-200 text-green-800 dark:bg-green-600 dark:text-white px-3 py-1">
                ✅ Hands-on Projects
              </Badge>
              <Badge className="bg-blue-200 text-blue-800 dark:bg-blue-600 dark:text-white px-3 py-1">
                ✅ Expert Mentorship
              </Badge>
              <Badge className="bg-purple-200 text-purple-800 dark:bg-purple-600 dark:text-white px-3 py-1">
                ✅ Lifetime Community Access
              </Badge>
              <Badge className="bg-orange-200 text-orange-800 dark:bg-orange-600 dark:text-white px-3 py-1">
