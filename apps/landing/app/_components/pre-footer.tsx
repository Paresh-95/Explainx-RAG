...
const navigation = {
  ...
  comparisons: [
      ...
      {name :"ExplainX vs Circle", href:"/compare/circle"},
      {name :"ExplainX vs Skool", href:"/compare/skool"},
      {name :"ExplainX vs Kajabi", href:"/compare/kajabi"},
      {name :"ExplainX vs MightyNetworks", href:"/compare/mightynetworks"},
      {name :"ExplainX vs YouLearn.ai", href:"/compare/youlearn"},
  ],
  forPages: [
...
export function PreFooter() {
    return (
        <footer className="relative bg-white dark:bg-[#1F1328] border-t border-gray-200/60 dark:border-white/10">
            <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
                ...
                <p className="mt-10 text-center text-xs leading-5 text-gray-600 dark:text-gray-400">
...
function FooterList(props: {
  ...
  return (
      <>
          <h3 className="text-sm font-semibold leading-6 text-gray-800 dark:text-white">
              {props.title}
          </h3>
