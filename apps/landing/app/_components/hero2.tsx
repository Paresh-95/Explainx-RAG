    ...
    return (
        <>
            <main className="overflow-hidden">
                    ...
                    <div className="relative pt-24 md:pt-36">
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                >
                                    <Link
                                        href="#link"
                                        className="hover:bg-background dark:hover:border-t-border bg-muted group mx-auto flex w-fit items-center gap-4 rounded-full border p-1 pl-4 shadow-md shadow-purple-500/10 transition-all duration-300 dark:border-purple-400/20 dark:shadow-purple-500/20">
                                        <span className="text-gray-600 dark:text-gray-400 text-sm">Trusted by Leading Organizations</span>
                                        <span className="dark:border-background block h-4 w-0.5 border-l bg-purple-200 dark:bg-purple-700"></span>

                                        <div className="bg-background group-hover:bg-muted size-6 overflow-hidden rounded-full duration-500">
                                            <div className="flex w-12 -translate-x-1/2 duration-500 ease-in-out group-hover:translate-x-0">
                                                <span className="flex size-6">
                                                    <ArrowRight className="m-auto size-3 text-purple-600 dark:text-purple-400" />
                                                </span>
                                                <span className="flex size-6">
                                                    <ArrowRight className="m-auto size-3 text-purple-600 dark:text-purple-400" />
                                                </span>
                                    ...
                                    <h1
                                        className="mt-8 max-w-4xl mx-auto text-balance text-6xl md:text-7xl font-cal lg:mt-16 xl:text-[5.50rem] bg-clip-text text-transparent bg-[linear-gradient(180deg,_#000_0%,_rgba(0,_0,_0,_0.75)_100%)] dark:bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)]">
                                        Organization Intelligence Platform
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg text-gray-600 dark:text-gray-300">
                                        Unlock your organization's collective intelligence with AI-powered knowledge management. Connect data, insights, and expertise to drive smarter decision-making across every department.
                                    </p>
                                </AnimatedGroup>
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        key={1}
                                        className="bg-purple-100/50 dark:bg-purple-900/20 rounded-[14px] border border-purple-200/50 dark:border-purple-400/20 p-0.5">
                                        <Button
                                            asChild
                                            size="lg"
                                            ...
                                            <Link href="https://learn.explainx.ai">
                        ...
                        <AnimatedGroup
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border border-purple-200/50 dark:border-purple-400/20 p-4 shadow-lg shadow-purple-500/15 ring-1">
                                    <img
                ...
                {/* <section className="bg-white dark:bg-[#1F1328] pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="flex justify-center mt-8">
                            <Link
                                href="/"
                                className="block text-sm text-purple-600 dark:text-purple-400 duration-150 hover:opacity-75">
    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12', isScrolled && 'bg-white/50 dark:bg-[#1F1328]/50 max-w-4xl rounded-2xl border border-purple-200/50 dark:border-purple-400/20 backdrop-blur-lg lg:px-5')}>
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full justify-between lg:w-auto">
                            ...
                            <button
                                ...
                                className="relative z-20 -m-2.5 -mr-4 block cursor-pointer p-2.5 lg:hidden text-purple-600 dark:text-purple-400">
                            ...
                            <ul className="flex gap-8 text-sm">
                                {menuItems.map((item, index) => (
                                    <li key={index}>
                                        <Link
                                            href={item.href}
                                            className="text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 block duration-150">
                                            <span>{item.name}</span>
                                        </Link>
                                    </li>
                                ))}
                        ...
                        <div className="bg-white/80 dark:bg-gray-900/50 group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-purple-200/50 dark:border-purple-400/20 p-6 shadow-2xl shadow-purple-500/10 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-purple-500/10 dark:lg:bg-transparent">
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                <Button
                                    ...
                                    variant="outline"
                                    size="sm"
                                    className={cn(isScrolled && 'lg:hidden', 'border-purple-200 dark:border-purple-400/20 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20')}>
                                    <Link href="#">
                                        <span>Login</span>
                                    </Link>
                                </Button>
                                <Button
                                    asChild
                                    size="sm"
                                    className={cn(isScrolled && 'lg:hidden', 'bg-gradient-to-r from-purple-600 to-pink-500 dark:from-purple-500 dark:to-pink-400 text-white shadow-lg shadow-purple-500/25 dark:shadow-purple-500/20 hover:shadow-xl hover:shadow-purple-500/35 dark:hover:shadow-purple-500/30 border border-purple-500/20 dark:border-purple-400/20')}>
                                    <Link href="#">
                                        <span>Sign Up</span>
                                    </Link>
                                </Button>
                                <Button
                                    asChild
                                    size="sm"
                                    className={cn(isScrolled ? 'lg:inline-flex' : 'hidden', 'bg-gradient-to-r from-purple-600 to-pink-500 dark:from-purple-500 dark:to-pink-400 text-white shadow-lg shadow-purple-500/25 dark:shadow-purple-500/20 hover:shadow-xl hover:shadow-purple-500/35 dark:hover:shadow-purple-500/30 border border-purple-500/20 dark:border-purple-400/20')}>
                                    <Link href="#">
