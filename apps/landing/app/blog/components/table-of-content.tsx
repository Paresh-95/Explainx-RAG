...
export function TableOfContents({ links }: { links: TOCLink[] }) {
  ...
  return (
    <nav aria-label="Table of contents" className="mb-8 bg-gray-50 dark:bg-[#0A0A0A]/90 rounded-lg p-4 border border-gray-200 dark:border-gray-800">
      <button
        onClick={() => setIsExpanded(!isExpanded)}
        className="w-full flex items-center justify-between text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
