...
export function Posts({ initialPosts }: PostsProps) {
  ...
  return (
    <div className="bg-white dark:bg-[#0A0A0A] py-24 sm:py-32 pt-28">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl">
          {/* Header Section */}
          <div className="flex flex-col sm:flex-row justify-between items-center mb-8">
            <div>
              <h2 className="font-cal text-3xl tracking-tight text-gray-900 dark:text-white sm:text-4xl">
                From the blog
              </h2>
          ...
          {currentPosts.length === 0 ? (
            ...
            <div className="mt-5 space-y-16 border-t border-gray-200 dark:border-gray-800 pt-10 sm:mt-16 sm:pt-16">
              {currentPosts.map((post) => (
                ...
                >
                  <div className="flex flex-wrap items-center gap-2 text-xs">
                    <time dateTime={post.datetime} className="text-gray-500 dark:text-gray-500">
                      {post.date}
                    </time>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {post.categories.map((category) => (
                        <button
                          ...
                          className="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white font-medium cursor-pointer"
                        >
                          #{formatCategory(category)}
                        </button>
                      ))}
                  ...
                  <div className="group relative">
                    <h3 className="mt-3 font-cal text-lg leading-6 text-gray-900 dark:text-white group-hover:text-gray-600 dark:group-hover:text-gray-300">
