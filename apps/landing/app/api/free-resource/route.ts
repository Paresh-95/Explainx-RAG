...
import { sendDiscordNotification } from "../../../lib/free-resources-notify";
...
export async function POST(req: Request) {
    try {
        ...
        try {
            await sendDiscordNotification(`A new subscriber has claimed a free resource: ${validatedData.name} (${validatedData.email})`);
