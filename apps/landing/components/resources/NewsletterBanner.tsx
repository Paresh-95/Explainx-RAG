...
export const NewsletterBanner = () => {
  ...
  return (
    <Card className="bg-gradient-to-r from-blue-100/40 to-purple-100/40 dark:from-blue-600/10 dark:to-purple-600/10 border border-blue-200 dark:border-blue-500/20 mb-6">
